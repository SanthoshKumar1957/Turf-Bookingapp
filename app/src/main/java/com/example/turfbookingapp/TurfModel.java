...
public class TurfModel {
    ...
    private String turf_name, turf_area, turf_price ,turf_num;
    private float turf_rating;

    TurfModel(String turf_name, String turf_area, String turf_num, int turf_img, float turf_rating, String turf_price) {
        this.turf_name = turf_name;
        this.turf_area = turf_area;
        this.turf_num = turf_num;
    ...
    public void setTurf_area(String turf_area) {this.turf_area = turf_area;}

    public String getTurf_num() {
        return turf_num;
    }

    public void setTurf_num(String turf_num) {
        this.turf_area = turf_num;
    }
